...
<header>
    <nav class="navbar navbar-xl navbar-dark navbar-expand-md wa-navbar">
        <div class="container-lg">
            <a class="navbar-brand" href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/wiryawan-adipa-logo.png" width="40px" height="40px" alt="Wiryawan Adipa Logo"><span>Wiryawan Adipa</span></a>
            ...
            <div class="collapse navbar-collapse mt-1 mt-md-0" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-md-0 me-md-2 mt-3 mt-md-0">
                    ...
                    <li class="nav-item mx-lg-1">
                        <a class="nav-link py-3 py-sm-2 px-2" href="<?php bloginfo('url'); ?>/about/">
                            About
                        </a>
                    </li>
