...
<header>
    <nav class="navbar navbar-xl navbar-dark navbar-expand-md wa-navbar">
        <div class="container-lg">
            <a class="navbar-brand" href="<?php bloginfo('url'); ?>"<?php if ( is_home() ) { echo ' aria-current="page"'; } ?>><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/wiryawan-adipa-logo.png" width="40px" height="40px" alt="<?php bloginfo( 'name' ); ?> Logo"><span class="fs-4 wa-brand-name">/wiryawan_adipa</span></a>
