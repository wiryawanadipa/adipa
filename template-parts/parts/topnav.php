...
<header>
    <nav class="navbar navbar-xl navbar-dark navbar-expand-md wa-navbar">
        <div class="container-lg">
            <a class="navbar-brand" href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/wiryawan-adipa-logo.png" width="40px" height="40px" alt="<?php bloginfo( 'name' ); ?> Logo"><span class="fs-4 wa-brand-name">/wiryawan_adipa</span></a>
            ...
            <div class="collapse navbar-collapse mt-1 mt-md-0" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-md-0 me-md-2 mt-3 mt-md-0">
                    <li class="nav-item mx-md-1">
                        <a class="nav-link fs-5 wa-top-menu<?php if ( is_home() ) { echo ' menu-active'; } ?>" href="<?php bloginfo('url'); ?>">home</a>
                    </li>
                    <li class="nav-item mx-md-1">
                        <a class="nav-link fs-5 wa-top-menu<?php if ( is_page( 'About' ) ) { echo ' menu-active'; } ?>" href="<?php bloginfo('url'); ?>/about/">about</a>
                    </li>
                    <li class="nav-item mx-md-1">
                        <a class="nav-link fs-5 wa-top-menu<?php if ( is_page( 'Contact' ) ) { echo ' menu-active'; } ?>" href="<?php bloginfo('url'); ?>/contact/">contact</a>
                    </li>
