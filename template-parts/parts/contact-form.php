				...
				<fieldset>
					<div class="row mb-0 mb-md-4">
						<div class="col-12 col-md-6 mb-4 mb-md-0">
							<input id="cf-name" class="form-control" name="contactName" type="text" placeholder="Please enter your full name here." value="<?php if( isset( $_POST['contactName'] ) ){ echo esc_attr($_POST['contactName']);} else { echo '';} ?>" required>
						</div>
						<div class="col-12 col-md-6 mb-4 mb-md-0">
							<input id="cf-email" class="form-control" name="email" type="email" placeholder="Please enter your e-mail address here." value="<?php if( isset( $_POST['email'] ) ){ echo esc_attr($_POST['email']);} else { echo '';} ?>" required>
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-12">                   
