		...
		<div class="top-menu">
			...
			<div id="main-menu" aria-labelledby="menu-icon">
				<ul>
					...
					<li><a <?php if (is_page('about')) { echo 'aria-current="page" '; } ?>href="<?php echo get_page_link_by_title('About'); ?>" title="About page" aria-label="About page">About</a></li>
					<li><a <?php if (is_page('contact')) { echo 'aria-current="page" '; } ?>href="<?php echo get_page_link_by_title('Contact'); ?>" title="Contact page" aria-label="Contact page">Contact</a></li>
				</ul>
			</div>
			<script>
