        ...
        <div class="wa-footer">
            <div class="container-xl py-5 wa-footer">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 small-text text-muted pt-2 pt-md-0 text-center text-md-start"><i class="fa-solid fa-building-shield"></i><a class="small-text text-muted privacy-policy" href="<?php echo esc_url( get_page_link( get_page_id_by_title( 'Privacy Policy' ) ) ); ?>"> Privacy Policy</a></div>
                    <div class="col-12 col-md-6"></div>
                    <div class="col-12 col-md-6 small-text text-muted pt-2 pt-md-0 text-center text-md-start"><i class="fa-brands fa-html5"></i> <a class="small-text text-muted theme-version" title="Wiryawan Adipa Wordpress Theme GitHub Repository Link" href="https://github.com/wiryawanadipa/adipa" target="_blank">Theme by Wiryawan Adipa v<?php $theme_version = wp_get_theme(); echo $theme_version->Version; ?></a></div>
                </div>
            </div>
        </div>
        <!-- wp_footer -->
