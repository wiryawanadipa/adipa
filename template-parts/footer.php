		<div class="footer">
			<div class="footer-box">
				<div class="footer-left">
					...
					<div class="theme"><i class="fa-brands fa-square-github"></i><a rel="nofollow noopener noreferrer" title="Wiryawan Adipa Wordpress Theme GitHub Repository" href="https://github.com/wiryawanadipa/adipa" target="_blank">Theme by Wiryawan Adipa v<?php echo wp_get_theme()->get( 'Version' ); ?></a></div>
				</div>
