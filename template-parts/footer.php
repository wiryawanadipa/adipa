        ...
        <div class="wa-footer">
            <div class="container-xl py-5 wa-footer">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 small-text text-muted pt-2 pt-md-0 text-center text-md-start"><i class="fa-solid fa-building-shield"></i><a class="small-text text-muted privacy-policy" href="<?php bloginfo('url'); ?>/privacy-policy/"> Privacy Policy</a></div>
                    <div class="col-12 col-md-6"></div>
