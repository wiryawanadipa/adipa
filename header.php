...
<html <?php language_attributes(); ?>>
	...
	<body>
		<header>
			<nav class="navbar navbar-xl navbar-dark navbar-expand-sm bd-navbar">
				<div class="container-lg">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ms-auto mb-2 mb-sm-0 me-sm-3">
						...
						<form class="d-flex" action="<?php bloginfo('url'); ?>" method="get" role="search">
							<input class="form-control me-lg-2" type="search" name="s" placeholder="Search" autocomplete="off" aria-label="Search" required>
						</form>
					</div>
				</div>
			</nav>
